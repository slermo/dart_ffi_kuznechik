...
import 'ffi_kuznechik_bindings_generated.dart';
...
const String _libName = 'ffi_kuznechik';

/// The dynamic library in which the symbols for [FfiKuznechikBindings] can be found.
...
final FfiKuznechikBindings _bindings = FfiKuznechikBindings(_dylib);
